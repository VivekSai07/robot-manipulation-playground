...
def main():
    parser = argparse.ArgumentParser(description="Mark-7 Vision Pipeline")
    parser.add_argument("--prompt", type=str, default="pick up the blue block",
                        help="Text prompt, e.g. 'pick up the yellow block'")
    parser.add_argument("--debug", action="store_true", help="Show live camera feed window")
