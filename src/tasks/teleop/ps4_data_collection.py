...
from src.controllers.ps4_teleop import PS4Teleop
...
def randomize_environment(m, d, robot, q_home_pin, q_target, target_se3):
    ...
    cube_id = m.body("target_cube_blue").id
...
def main():
    print("🚀 Initializing Franka Mark-6 PS4 Teleop (Data Collection Pipeline)...")
    ...
    grasp_sys = GraspController(m, d, target="target_cube_blue")
    teleop = PS4Teleop()
    logger = DataLogger()
    ...
    print("\n🟢 Data Pipeline Online. Grab your controller.")
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        # Snapshot pure graphics settings
        ...
        while viewer.is_running():
            ...
            sys.stdout.write(f"\r🎮 Episode: {episode_count} | Steps: {step_count} | [Circle] Reset | [Cross] Grip | [Sticks] Drive")
            sys.stdout.flush()
            # -----------------------------------
